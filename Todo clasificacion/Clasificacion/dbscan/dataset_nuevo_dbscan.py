...
# ========= CONFIG =========
EXCEL_PATH = Path("/home/vale/Escritorio/Proyecto tesis/Clasificacion/dbscan/clasificacion_dbscan.xlsx")
ROOT_OPTIM = Path("/home/vale/Escritorio/ibex-lib/benchs/optim")
OUTPUT_JSONL = Path("dataset_nuevo_dbscan.jsonl")

# Solo KMeans
NAME_CANDIDATES = ["nombre", "problem", "problema"]
NEW_DIFF_CANDIDATES = ["dificultad_dbscan"]
